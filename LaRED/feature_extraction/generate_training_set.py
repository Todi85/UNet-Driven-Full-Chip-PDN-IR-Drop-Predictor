...
def parse_args():
    ...
    parser.add_argument('--process_capacity', default=8, help='number of process for multi process')
...
if __name__ == '__main__':
    ...
    feature_list = ['features/total_power', 'features/eff_res_VDD', 'features/eff_res_VSS', 'features/min_res_VDD', 'features/min_res_VSS']
    label_list = ['features/VDD_GND']
